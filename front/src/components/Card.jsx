...
function Card({item}) {
  ...
  return (
      ...
      <div className='min-w-[420px]  w-[420px] h-[450px] bg-white shadow-md rounded-xl flex gap-2  flex-col items-center p-4 hover:scale-[102%] duration-200 hover:-translate-y-0.5 '>
